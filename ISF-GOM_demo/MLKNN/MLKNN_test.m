function [HammingLoss,OneError,Average_Precision,Outputs,Pre_Labels]=MLKNN_test(dist_matrix,train_target,test_target,Num,Prior,PriorN,Cond,CondN)
%MLKNN_test tests a multi-label k-nearest neighbor classifier.
%
%    Syntax
%
%       [HammingLoss,OneError,Average_Precision,Outputs,Pre_Labels]=MLKNN_test(train_data,train_target,test_data,test_target,Num,Prior,PriorN,Cond,CondN)
%
%    Description
%
%       KNNML_test takes,
%           dist_matrix      - An M2xM1 array, distances between training instances and testing instances
